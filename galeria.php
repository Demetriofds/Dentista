...
<html>
	<head>
	<title>Clínica Odontológica | Galeria</title>
	<!-- for-mobile-apps -->
		...
		<div class="header-bottom">
			<div class="container">
				<div class="header-bottom-right">
					<ul>
						<li class="mail"><a href="mailto:info@example.com">atendimento@dranderson.com.br</a></li>
						<li class="phone"><span> </span></li>
						<li class="num">11 98934-2271</li>
					</ul>
				</div>
			...
			<div class="container">
				...
				<div class="gallery-grids">
					<div class="gallery-grid">
						<a class="fancybox" href="images/protese-01.jpg" data-fancybox-group="gallery"><img src="images/3.jpg" class="img-style row6 img-responsive" alt="" /><span> </span></a>
					</div>
					<div class="gallery-grid1">
						<a class="fancybox" href="images/protese-02.jpg" data-fancybox-group="gallery"><img src="images/9.jpg" class="img-style row6 img-responsive" alt="" /><span> </span></a>
					</div>
					<div class="gallery-grid">
				...
				<div class="gallery-grids">
					...
					<div class="gallery-grid1">
						<a class="fancybox" href="images/orto-implante.jpg" data-fancybox-group="gallery"><img src="images/9.jpg" class="img-style row6 img-responsive" alt="" /><span> </span></a>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="gallery-grids">
